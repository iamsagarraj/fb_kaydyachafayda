...
# Using Llama 3 (excellent Marathi support)
...
# --- 4. GENERATE CONTENT (Hugging Face) ---
prompt = f"Write a professional Facebook post in Marathi for Advocate Sagar Shirsat. Topic: {niche} ({topic}). Use a professional Puneri Marathi tone. Headline should be bold."

print(f"Generating via Hugging Face for: {niche}...")

try:
    # Calling Llama 3 - very stable free API
